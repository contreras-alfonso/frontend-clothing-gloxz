...
const ListaCarrito = ({ listCart,setListCart }) => {
  ...
  return (
    <div>
        ...
        <div className={`bg-white transition-all duration-75 h-screen fixed z-40 bottom-0 top-0 cursor-default ${listCart ? 'px-5 w-[500px]' : 'w-0'}`}>
            <div className={`transition-all duration-1000 ${listCart ? 'contents' : 'hidden'}`}>
                ...
                <div className='flex justify-between gap-3'>
                    <button className='w-1/2 rounded border-[1px] border-black bg-transparent py-3 px-10 transition-all duration-300 hover:bg-black hover:text-white'>View cart</button>
