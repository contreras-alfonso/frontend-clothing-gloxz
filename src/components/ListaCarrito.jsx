...
const ListaCarrito = ({ listCart,setListCart }) => {
  ...
  return (
    <div>
        ...
        <div className={`overflow-y-auto bg-white transition-all duration-300 h-screen fixed z-40 bottom-0 top-0 right-0 cursor-default ${listCart ? 'px-5 w-[500px]' : 'w-0'}`}>
            <div className={`transition-all duration-500 ${listCart ? '' : 'hidden'}`}>
                ...
                <div className='bg-red-600 py-2 text-white text-center'>
                    <p><i className="fa-duotone fa-fire"></i> Checkout now 09:14 before they’reGONE!</p>
                </div>
