            ...
            <div className='w-1/2 space-y-3'>
                ...
                <div className='flex gap-2'>
                    <div className='flex items-center gap-4 border-[1px] border-slate-200 w-fit'>
                            <button className='px-5'><i className="fa-light fa-minus"></i></button>
                            <span className=''>4</span>
                            <button className='px-5'><i className="fa-light fa-plus"></i></button>
                    </div>
                    <button className='w-fit rounded border-black border-[1px] py-3 px-10 transition-all duration-300 bg-black text-white hover:bg-white hover:text-black text-sm'>Add to cart</button>
